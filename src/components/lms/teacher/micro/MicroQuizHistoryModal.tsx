...
export function MicroQuizHistoryModal({ courseId, onClose, onSelectJob }: Props) {
 ...
 <p className="text-text-muted">Chưa có tiến trình tạo quiz nào.</p>
 </div>
 ) : (
 ...
 className="group flex items-center gap-4 p-4 rounded-xl border border-border-subtle hover:border-emerald-500 dark:hover:border-emerald-500 cursor-pointer transition-colors bg-bg-card hover:shadow-sm"
 >
