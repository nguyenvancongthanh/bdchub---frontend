...
export function GenerateSectionOverviewModal({
 ...
 <div className="bg-bg-card rounded-2xl max-w-lg w-full shadow-2xl">
 {/* Header */}
 <div className="sticky top-0 bg-bg-card border-b border-border-subtle px-6 py-4 flex items-center justify-between rounded-t-2xl">
 ...
 className="w-full px-3 py-2 rounded-lg border border-border-input dark:border-border-subtle bg-bg-card text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
 >
 ...
 className="w-full px-3 py-2 rounded-lg border border-border-input dark:border-border-subtle bg-bg-card text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
 />
 <p className="text-xs text-text-disabled mt-1">Từ 5 đến 30 câu</p>
 </div>
 ...
 <button
 onClick={onClose}
 className="px-4 py-2 rounded-lg text-sm font-medium text-text-muted hover:bg-bg-hover transition-colors active:scale-95"
 >
 Huỷ
 </button>
 <button
