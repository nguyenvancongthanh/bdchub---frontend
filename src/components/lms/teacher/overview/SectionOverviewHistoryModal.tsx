...
export function SectionOverviewHistoryModal({
 ...
 <p className="text-sm text-text-muted mt-1 ml-7 truncate max-w-sm">
 {sectionTitle}
 </p>
 </div>
 <button
 ...
 className="group flex items-center gap-4 p-4 rounded-xl border border-border-subtle hover:border-indigo-500 dark:hover:border-indigo-500 cursor-pointer transition-colors bg-bg-card hover:shadow-sm"
 >
 {/* Status icon */}
