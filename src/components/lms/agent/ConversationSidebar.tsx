...
>(function ConversationSidebar(
 ...
 <div
 className={cn(
"flex flex-col h-full bg-bg-section/85 dark:bg-bg-card/85 backdrop-blur-md",
"border-r border-border-subtle/60 dark:border-border-subtle/60",
 className,
 )}
 >
 <div className="p-4 border-b border-border-subtle/60 dark:border-border-subtle/60 flex items-center gap-2">
 <button
...
"px-4 py-2.5 rounded-xl transition-all duration-200 shadow-md shadow-blue-500/10 hover:shadow-lg hover:shadow-blue-500/20",
 ...
 className="lg:hidden p-2.5 rounded-xl border border-border-subtle/60 dark:border-border-subtle/60 hover:bg-bg-hover text-text-muted transition-colors active:scale-95 flex-shrink-0"
 ...
 {isLoading ? (
 <div className="flex justify-center items-center h-20 text-text-disabled">
 <Loader2 className="w-5 h-5 animate-spin" />
 </div>
 ) : sessions.length === 0 ? (
 <div className="text-center text-sm text-text-disabled/80 py-10">
...
"w-full text-left px-3 py-3 rounded-xl transition-all duration-200 border-l-4 cursor-pointer group flex items-center justify-between gap-2 active:scale-[0.98]",
 ...
 :"hover:bg-bg-section/40 dark:hover:bg-bg-hover/40 border-transparent",
 )}
 >
 <div className="flex items-start gap-3 flex-1 min-w-0">
 <div className={cn("mt-0.5 transition-colors duration-200 flex-shrink-0", isActive ?"text-blue-500 dark:text-blue-400" :"text-text-disabled")}>
...
"vi-VN",
 ...
 <span className="mx-1 text-text-disabled dark:text-text-body">•</span>
 ...
 className="opacity-0 group-hover:opacity-100 p-1.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-950/30 text-text-disabled hover:text-red-600 dark:hover:text-red-400 transition-all duration-150 active:scale-90 flex-shrink-0"
