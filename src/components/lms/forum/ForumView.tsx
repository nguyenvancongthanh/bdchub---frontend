...
"votes" |"newest" |"oldest" |"views"
 ...
 className="flex items-center gap-2 bg-accent-primary hover:bg-accent-primary-hover text-white font-semibold rounded-xl px-6 py-3 shadow-sm transition-all active:scale-95"
 >
 ...
 <div className="text-center py-12 bg-bg-card rounded-2xl border border-border-subtle shadow-sm">
 ...
 disabled={page === 1}
 className="bg-bg-card border border-border-input text-text-body hover:bg-bg-hover rounded-xl px-4 py-2 font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed"
 >
 Trước
 </button>
