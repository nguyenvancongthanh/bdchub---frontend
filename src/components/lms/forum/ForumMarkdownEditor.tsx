...
"[data-forum-editor]"
 ...
 return (
 <div className="border border-border-input rounded-xl overflow-hidden transition-all focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:border-blue-500">
 {/* Tabs + Toolbar */}
 <div className="flex items-center justify-between border-b border-border-subtle bg-bg-section dark:bg-bg-hover px-3 py-1.5">
 ...
 activeTab ==="write"
 ?"bg-bg-card dark:bg-bg-hover text-text-heading shadow-sm"
 :"text-text-muted hover:text-text-body dark:hover:text-text-disabled"
 }`}
 >
 Viết
 </button>
 ...
 className="p-1.5 text-text-muted hover:text-text-body dark:hover:text-text-disabled hover:bg-bg-hover rounded transition-colors"
 title="In đậm"
 >
 ...
 disabled={disabled}
 className={`w-full px-4 py-3 text-text-heading
 ...
 <div
 className={`px-4 py-3 bg-bg-card ${
 ...
 <p className="text-text-disabled dark:text-text-muted italic text-sm">
 ...
 {/* Markdown hint */}
 {!compact && (
 <div className="px-3 py-1.5 border-t border-border-subtle bg-bg-section dark:bg-bg-hover">
