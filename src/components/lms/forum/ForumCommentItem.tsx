...
export default function ForumCommentItem({
 ...
 <button
 onClick={handleEdit}
 className="bg-accent-primary hover:bg-accent-primary-hover text-white font-semibold rounded-xl px-4 py-2 text-sm transition-all active:scale-95"
 >
 Lưu
 </button>
 <button
 ...
 className="bg-bg-card border border-border-input text-text-body hover:bg-bg-hover rounded-xl px-4 py-2 text-sm font-medium transition-all active:scale-95"
 >
 Hủy
 </button>
 </div>
 ...
 className="flex items-center gap-1 text-text-muted hover:text-text-subheading dark:hover:text-text-disabled transition-colors"
 >
 ...
 />
 <div className="absolute right-0 top-full mt-1 bg-bg-card border border-border-input rounded-lg shadow-lg py-1 z-20 min-w-[120px]">
 <button
 onClick={() => {
 setEditing(true);
 setShowActions(false);
 }}
 className="w-full px-3 py-2 text-left text-sm text-text-body hover:bg-bg-hover flex items-center gap-2 transition-colors"
 >
 ...
 className="bg-accent-primary hover:bg-accent-primary-hover disabled:bg-bg-hover dark:disabled:bg-bg-hover text-white font-semibold rounded-xl px-4 py-2 text-sm transition-all active:scale-95 disabled:cursor-not-allowed"
 >
