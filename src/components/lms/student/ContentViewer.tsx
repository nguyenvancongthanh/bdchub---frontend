...
export default function ContentViewer({
 ...
 <details className="text-xs bg-bg-section border border-border-subtle rounded-xl p-3">
 <summary className="cursor-pointer font-mono text-text-muted">Debug</summary>
 <pre className="mt-2 overflow-auto text-text-muted">
