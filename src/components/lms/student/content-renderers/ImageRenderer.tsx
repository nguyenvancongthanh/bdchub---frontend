...
export function ImageRenderer({ content }: ImageRendererProps) {
 ...
 <div className="relative bg-bg-section rounded-2xl overflow-hidden shadow-sm min-h-[200px]">
 {!loaded && !error && (
 ...
 <p className="text-text-muted text-sm">Không thể tải hình ảnh.</p>
 </div>
 ) : (
 ...
 className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium bg-accent-primary hover:bg-accent-primary-hover text-white rounded-xl shadow-sm transition-all active:scale-95"
 >
 Xem kích thước gốc
 </a>
