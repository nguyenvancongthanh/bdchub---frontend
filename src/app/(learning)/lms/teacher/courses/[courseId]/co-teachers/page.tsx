            ...
            <form onSubmit={handleAdd} className="space-y-3.5">
              <div className="relative" ref={dropdownRef}>
                ...
                {showDropdown && searchResults.length > 0 && (
                  <div className="
                    ...
                    rounded-xl shadow-lg divide-y divide-slate-100 dark:divide-slate-800
                  ">
                    {searchResults.map(u => (
                      <button
                        key={u.id}
                        ...
                        className="
                          ...
                          hover:bg-slate-50 dark:hover:bg-slate-800/65 text-left
              ...
              <button
                ...
                className="
                  ...
                  bg-blue-600 hover:bg-blue-700 disabled:bg-blue-600/50 text-white font-semibold text-sm
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-800 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-white dark:bg-slate-900">
              {coTeachers.map(ct => (
                ...
                >
                  ...
                  <div className="w-10 h-10 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center font-bold text-sm text-blue-600 dark:text-blue-400 flex-shrink-0">
                  ...
                  {canManage && (
                    <button
                      ...
                      className="
                        p-2 text-slate-400 hover:text-red-500 dark:hover:text-red-400
