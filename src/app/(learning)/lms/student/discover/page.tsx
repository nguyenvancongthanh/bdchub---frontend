...
export default function DiscoverPage() {
 ...
 <div>
 <h1 className="text-3xl font-extrabold font-heading text-text-heading leading-tight">
 Khám phá khóa học
 </h1>
 ...
 className="py-2.5 px-3 border border-border-input rounded-xl text-sm bg-bg-input text-text-heading focus:outline-none focus:ring-2 focus:ring-border-focus/20 focus:border-border-focus transition-all"
 >
